...
<body>
  <center>
    <p><strong>Laporan Penjualan</strong><br>
      <br><br>
  </center>
  ...
  <table rules="all" width="100%" cellpadding="2" >
    <thead>
      ...
      <tr>
        ...
        <th style="background-color: #f2f2f2; text-align: center; ">Diskon</th>
    ...
    <tfoot>
      <tr>
    <td style="text-align: center;" colspan="5"><strong>Total Penjualan</strong></td>
