        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <img class="img-xs rounded-circle" src="{{ ('data_foto')}}/{{Session::get('foto')}}" alt="Profile image">
            </a>
        ...
        <ul class="nav">
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                ...
                <div class="text-wrapper">
                  ...
                  <div>
                    <small class="designation text-muted">{{Session::get('jabatan')}}</small>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="{{'tabelAdmin'}}">Admin</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{'tabelUser'}}">Pengguna</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{'keterangan'}}">
              <i class="menu-icon mdi mdi-television"></i>
              <span class="menu-title">Biodata Toko</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/asset/pages/icons/font-awesome.html">
