                    ...
                    <div class="modal-body">
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          <input type="hidden" value="{{$data->id }}" class="form-control" name="idProduk" readonly required>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ $data->nama_produk }}" class="form-control" name="namaProduk" readonly required >
                        </div>
                        @endforeach
