            ...
            <div class="box-body">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="kode_produk" name="kode_produk" class="form-control"   autofocus required>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="nama_produk" name="nama_produk" class="form-control"    required readonly>
                      ...
                      <div class="form-group">
                        <label>Harga</label>
                        <input type="text" id="harga_jual" name="harga" class="form-control"    required readonly>
                      </div>
              ...
              <hr>
                <div class="table-responsive">
                  ...
                  <a href="/penjualan/offline" type="button" class="btn btn-warning"><i class="fa fa-chevron-left"></i> Kembali  </a>
                </div>
      </div>
    </div>
  </div>
